...
export const REMOVE_POST_MODAL = 'REMOVE_POST_MODAL';
...
export const CLEAR_POST_CONTENT = 'CLEAR_POST_CONTENT';
export const FETCH_HASHTAG_POSTS = 'FETCH_HASHTAG_POSTS';
